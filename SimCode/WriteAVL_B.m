function [avlFile, massFile, runFile] = WriteAVL_B(design)
...
% wing surface
% WriteSurface(fileAVL, 'WING', wing.n_cho, 1.0, wing.n_spa, 1.0, linewrite); _A
WriteSurface(fileAVL, 'WING', wing.n_cho, 1.0, [], [], linewrite); % _B

% wing left section
% WriteSection(fileAVL, wing.xle, -wing.span + wing.yle, wing.zle, ...
%     wing.chord, 0.0, [], [], 'NACA 0015');
WriteSection(fileAVL, wing.xle, -wing.span + wing.yle, wing.zle, ...
