...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
runs.name = 'test_span_case2';     % name of files without extensions
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
wing.d_ail = 15;                     % [deg] aileron deflection
...
% wing.d_fps = [5, 7.5, 10];          % flap deflection, [boom to tip flaps][F1, F2, F3] 
wing.d_fps = [-15, 15, -15];
...
% electronics package
runs.elecs = 0.5;   % [kg] electronics mass
...
% 
% figure(1);
% set(gcf, 'Position', [297   437   560   420])
% figure(2);
% set(gcf, 'Position', [897   437   560   420])