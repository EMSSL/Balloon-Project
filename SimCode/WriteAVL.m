function [avlFile, massFile, runFile] = WriteAVL(design)
...
% wing surface
WriteSurface(fileAVL, 'WING', wing.n_cho, 1.0, wing.n_spa, 1.0, linewrite);

% wing left section
WriteSection(fileAVL, wing.xle, -wing.span + wing.yle, wing.zle, ...
    wing.chord, 0.0, wing.n_spa, 1.0, 'NACA 0015');

%%%%% ADD IN AILERON WRITING TO FILES
...
WriteSection(fileAVL, rudder.xle, -rudder.span - rudder.yle, rudder.zle, ...
    rudder.chord, 0.0, rudder.n_spa, 1.0, 'NACA 0015');
...
fprintf(fID, '%5.2f%5.2f%5.2f%5.2f%5.2f%5.2f%5.2f%5.2f%5.2f%5.2f%s\n', ...
